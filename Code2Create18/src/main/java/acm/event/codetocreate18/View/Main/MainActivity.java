...
import acm.event.codetocreate18.View.Fragments.FaqFragment;
import acm.event.codetocreate18.View.Fragments.QuizFragment;
import acm.event.codetocreate18.View.Fragments.SponsorFragment;
import acm.event.codetocreate18.View.Fragments.TimelineFragment;
import acm.event.codetocreate18.View.Fragments.WifiDetails;
import acm.event.codetocreate18.View.Fragments.contactWeb;
import acm.event.codetocreate18.View.Fragments.prizeFragment;
import acm.event.codetocreate18.View.Fragments.scannerMessage;
...
public class MainActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private void createMenuList() {
        ...
        list.add(menuItem1);
        SlideMenuItem menuItem2 = new SlideMenuItem("Timeline", R.drawable.ic_timelinesvg);
        list.add(menuItem2);
      //  if(!Constants.isGuest) {
        //    SlideMenuItem menuItem3 = new SlideMenuItem("Team", R.drawable.ic_group);
          //  list.add(menuItem3);
        //}
        SlideMenuItem menuItem3 = new SlideMenuItem("Quiz", R.drawable.ic_scansvg);
        list.add(menuItem3);
        SlideMenuItem menuItem4 = new SlideMenuItem("About Us", R.drawable.ic_aboutsvg);
        list.add(menuItem4);
        if(!Constants.isGuest) {
            SlideMenuItem menuItem5 = new SlideMenuItem("Wifi", R.drawable.ic_wifisvg);
            list.add(menuItem5);
        }
        SlideMenuItem menuItem6 = new SlideMenuItem("FAQ", R.drawable.ic_faq);
        list.add(menuItem6);
        SlideMenuItem menuItem7 = new SlideMenuItem("Sponsors", R.drawable.ic_sponsorsvg);
        list.add(menuItem7);
        SlideMenuItem menuItem8 = new SlideMenuItem("Prizes", R.drawable.ic_couponsvg);
        list.add(menuItem8);
        SlideMenuItem menuItem9 = new SlideMenuItem("C2CWebsite", R.drawable.ic_websvg);
        list.add(menuItem9);
        SlideMenuItem menuItem10 = new SlideMenuItem("Facebook", R.drawable.ic_fbsvg);
        list.add(menuItem10);
        SlideMenuItem menuItem11 = new SlideMenuItem("Slack", R.drawable.ic_slacksvg);
        list.add(menuItem11);
        SlideMenuItem menuItem12 = new SlideMenuItem("Logout", R.drawable.ic_logout);
        list.add(menuItem12);
    }
...
*/
    ...
    public ScreenShotable loadWifiFragment() {
        WifiDetails wifiFragment = new WifiDetails();
        getSupportFragmentManager().beginTransaction().replace(R.id.main_content_frame, wifiFragment).commit();
        return wifiFragment;
    }

    public ScreenShotable loadPrizeFragment() {
        prizeFragment prizefragment = new prizeFragment();
        getSupportFragmentManager().beginTransaction().replace(R.id.main_content_frame, prizefragment).commit();
...
*/
        ...
        return screenShotable;
           ...
           // case "Team":
            ...
            case "Wifi":
                ...
                return loadWifiFragment();
            case "Prizes":
                getSupportActionBar().setTitle("Prizes");
                return loadPrizeFragment();
            case "About Us":
    ...
    public void loadWebsite() {
        Intent intent = new Intent(this, contactWeb.class);
        intent.putExtra("url", "http://c2c.acmvit.in");
        startActivity(intent);
    }

    public void loadMessageFragment() {
        Intent intent = new Intent(this, scannerMessage.class);
        startActivity(intent);
    }

    public void loadFacebook() {
        Intent intent = new Intent(this, contactWeb.class);
        intent.putExtra("url", "http://www.facebook.com/acm.vitu");
        startActivity(intent);

    }

    public void loadSlack() {
        Intent intent = new Intent(this, contactWeb.class);
        intent.putExtra("url", "https://code2creategroup.slack.com");
        startActivity(intent);
